...
print "A Perl Script for getting the slots of a class\n";
...
$command = "gfp%3Aget-frame-slots-internal+";
...
$defaults = $colon . "all+" . $colon . "all)";

$all = "-source \"" . $baseString . $args . $command;
$all = $all . $class . $kbSearch . $defaults . "\"";
