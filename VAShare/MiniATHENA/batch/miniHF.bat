...
set GUIDELINEFILE="%MINIATHENA%\kb\ATHENA_HF.pprj"
...
%JRE%\bin\java %OPTIONS%  -Dprotege.dir="%LIB%"   -cp %CLASSPATH% edu.stanford.smi.eon.clients.ATHENA_Standalone 1316243 %MINIATHENA%\data\1316243.xml %MINIATHENA%\kb\ATHENA_HF.pprj  %MINIATHENA%\output\ "ATHENA Heart Failure Guideline" HF.xml
