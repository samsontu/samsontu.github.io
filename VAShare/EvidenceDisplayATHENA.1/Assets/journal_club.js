...
= "menu_flt_aboutacpjc.gif"; menu_graphic_width = "104"; indent_shim = "<img src=../Original_PNG//%22/images/float_indent_shim.gif/%22>"; 
} else if (floatitems[count-1] == "ebmabout") { menu_graphic = "menu_flt_nature.gif"; 
menu_graphic_width = "103"; indent_shim = "<img src=../Original_PNG//%22/images/float_indent_shim.gif/%22>"; 
} else if (floatitems[count-1] == "resabout") { menu_graphic = "menu_flt_research_methods.gif"; 
menu_graphic_width = "80"; indent_shim = "<img src=../Original_PNG//%22/images/float_indent_shim.gif/%22>"; 
} else if (floatitems[count-1] == "anaabout") { menu_graphic = "menu_flt_analysis.gif"; 
menu_graphic_width = "98"; indent_shim = "<img src=../Original_PNG//%22/images/float_indent_shim.gif/%22>"; 
} else if (floatitems[count-1] == "traabout") { menu_graphic = "menu_flt_transfer.gif"; 
menu_graphic_width = "92"; indent_shim = "<img src=../Original_PNG//%22/images/float_indent_shim.gif/%22>"; 
} else if (floatitems[count-1] == "eduabout") { menu_graphic = "menu_flt_education.gif"; 
menu_graphic_width = "91"; indent_shim = "<img src=../Original_PNG//%22/images/float_indent_shim.gif/%22>"; 
} else if (floatitems[count-1] == "eviabout") { menu_graphic = "menu_flt_inforesources.gif"; 
menu_graphic_width = "97"; indent_shim = "<img src=../Original_PNG//%22/images/float_indent_shim.gif/%22>"; 
} else if (floatitems[count-1] == "decabout") { menu_graphic = "menu_flt_decision.gif"; 
menu_graphic_width = "69"; indent_shim = "<img src=../Original_PNG//%22/images/float_indent_shim.gif/%22>"; 
...
= "menu_flt_directlinks.gif"; menu_graphic_width = "56"; indent_shim = "<img src=../Original_PNG//%22/images/float_indent_shim.gif/%22>"; 
} else if (floatitems[count-1] == "jcabout") { menu_graphic = "menu_flt_aboutacpjc.gif"; 
menu_graphic_width = "104"; indent_shim = "<img src=../Original_PNG//%22/images/float_indent_shim.gif/%22>"; 
} else if (floatitems[count-1] == "reachus") { menu_graphic = "menu_flt_reachus.gif"; 
menu_graphic_width = "50"; indent_shim = "<img src=../Original_PNG//%22/images/float_indent_shim.gif/%22>"; 
...
indent_shim = "<img src=../Original_PNG//%22/images/float_indent_shim.gif/%22>"; 
} else if (floatitems[count-1] == "content") { menu_graphic = "menu_flt_edit-cont.gif"; 
menu_graphic_width = "78"; indent_shim = "<img src=../Original_PNG//%22/images/float_indent_shim.gif/%22>"; 
} else if (floatitems[count-1] == "acce") { menu_graphic = "menu_flt_subs-adv.gif"; 
menu_graphic_width = "90"; indent_shim = "<img src=../Original_PNG//%22/images/float_indent_shim.gif/%22>"; 
} /* END Float Items Specifically for /shared/site_map.htm */ /* else if (floatitems[count-1] 
== "xxxxxxxxxxxxxxx") { menu_graphic = "menu_flt_figs_tables.gif"; menu_graphic_width 
= "95"; indent_shim = ""; } else if (floatitems[count-1] == "xxxxxxxxxxxxx") { 
menu_graphic = "menu_flt_fig.gif"; menu_graphic_width = "30"; indent_shim = ""; 
} else if (floatitems[count-1] == "xxxxxxxxxxxxx") { menu_graphic = "menu_flt_table.gif"; 
menu_graphic_width = "26"; indent_shim = ""; } */ /* If a floatitem does not match 
any of the conditionals above, then nothing should happen or be done to the floater 
menu. The if test below only appends the floater_menu variable if one of my defined 
image names and widths matches one of Thom's floatitems[n] in the source file. 
*/ if (menu_graphic!="" && menu_graphic_width!="") { /* if (just_the_file_name!="INDEX.HTM" 
&& just_the_file_name!="index.htm" && just_the_file_name!="index.htm#Reso") { 
floater_menu += '<a href="#' + floatitems[count-1].substring(0,4).toLowerCase() + '" onMouseOut="ImageOut(&#039;lbullet_' + count + '&#039;)" onMouseOver="ImageOver(&#039;lbullet_' + count + '&#039;)"><img name="lbullet_' + count + '" src="journal_club.js" alt="' + floatitems[count-1] + '" width="15" height="9" border="0" vspace="3"></a><a href="#' + floatitems[count-1].substring(0,4).toLowerCase() + '" onMouseOut="ImageOut(&#039;lbullet_' + count + '&#039;)" onMouseOver="ImageOver(&#039;lbullet_' + count + '&#039;)"><img src="/images/' + menu_graphic + '" alt="' + floatitems[count-1] + '" width="' + menu_graphic_width + '" height="9" border="0" vspace="3"></a><br>
...
function prevnext() {
        ...
        if (window.homepage && homepage==1)
        {
            document.write("<img src=../Original_PNG//%22/images/homepage_datecell_spacer.gif/%22 width=\"156\" height=\"1\" border=\"0\" alt=\"\"><br><font size=\"1\" color=\"#00000\" face=\"arial, sans-serif\" class=\"homepagedateline\">" + dateline + "</font>");
        }

        else if (prev=="")
        document.write("<img src=../Original_PNG//%22/images/prevnext_none.gif/%22 alt=\"\" width=\"156\" height=\"21\" border=\"0\">");
...
*/
    ...
    if (prev!="0.htm")
        document.write("<a href=\"" + slash + prev + "\"><img src=../Original_PNG//%22/images/prev_on.gif/%22 alt=\"Prev\" width=\"38\" height=\"21\" border=\"0\"></a>");
    else {
        document.write("<img src=../Original_PNG//%22/images/prev_off.gif/%22 alt=\"\" width=\"38\" height=\"21\" border=\"0\"></a>");
    }

    if (index_page!=1)
        document.write("<img src=../Original_PNG//%22/images/item_article.gif/%22 alt=\"Issue\" width=\"69\" height=\"21\" border=\"0\">");
    else {
        document.write("<img src=../Original_PNG//%22/images/item_issue.gif/%22 alt=\"Issue\" width=\"69\" height=\"21\" border=\"0\">");
    }

    if (next!="0.htm" && next!="")
    //Above if statement modified Wednesday, August 29, 2001. Added && clause.
        document.write("<a href=\"" + slash + next + "\"><img src=../Original_PNG//%22/images/next_on.gif/%22 alt=\"Next\" width=\"49\" height=\"21\" border=\"0\"></a>");
    else {
        document.write("<img src=../Original_PNG//%22/images/next_off.gif/%22 alt=\"\" width=\"49\" height=\"21\" border=\"0\"></a>");
    }
...
if (just_the_file_name!="INDEX.HTM" && just_the_file_name!="index.htm" && completefilepath.indexOf("shared")==-1 && completefilepath.indexOf("-A")==-1 && !window.errorpage)
    ...
    document.write('<img src="/images/shim.gif" alt="" width="60" height="1" border="0"><A href="../Original_PNG/index.html" onMouseOut="ImageOut(&#039;tbullet&#039;);" onMouseOver="ImageOver(&#039;tbullet&#039;);"><img src="/images/toc_markertop.gif" alt="Table of Contents" width="86" height="9" border="0"><img name="tbullet" SRC="/images/arrow_left_out.gif" alt="" width="6" height="9" border="0"></A>' + "&nbsp;&nbsp;<b>" + dateline + "</b>");
